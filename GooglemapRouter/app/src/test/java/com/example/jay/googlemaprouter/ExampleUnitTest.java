...
public class ExampleUnitTest {
   /* @Test
    ...
    public void maproute_isCorrect() throws Exception
    {
        ...
        mapNode val1 = new mapNode(new LatLng(37.335799,-121.882925));
        route.clear();
        route.add(graph.v.get(9).latLng);
        route.add(graph.v.get(13).latLng);
        route.add(val1.latLng);
        assertEquals(route,graph.maproute(val1,graph.v.get(9)));
    ...
    public void mapConnectRoute_isCorrect() throws Exception
   {
    ...
    public void nearestCheckpoints_isCorrect() throws Exception
    {
        ...
        assertEquals(graph.v.get(13),graph.nearestCheckpoints(destination,graph.v.get(4)));
        assertEquals(graph.v.get(13),graph.nearestCheckpoints(graph.v.get(13),graph.v.get(4)));
    ...
    public void readStrToLalLong_isCorrect() throws Exception {
        ...
        InputStream input = new ByteArrayInputStream("#37.123456@-121.345123\n".getBytes());
        LatLng pos = new LatLng(37.123456,-121.345123);
        assertEquals(pos,bleComm.readStrToLalLong(input));
        ...
        input = new ByteArrayInputStream("#37.1234561111111111111111111111111111111111111@-121.345323232321111111111111111111111111111111111111111111111\n".getBytes());

...
void period_100Hz(uint32_t count)
{
	...
	motor_msg_to_send = (MOTOR_SIGNAL_t *) set_motor_direction_and_speed(&lights, left,middle,right,rear,(void *) &gps_car_running);

	// If any of the GPS, Sensor module is disconnected or blue tooth App stop command occurs

	if(((!ble_start_signal.BRIDGE_START) || (bridge_heartbeat.mia_info.is_mia) || (sensor_msg_decoded.mia_info.is_mia) || (gps_heartbeat.mia_info.is_mia)) ==1)
